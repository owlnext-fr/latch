...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        // Bordure : même teinte que --input (hue 48.717 / chroma 0.003) mais lightness
        // abaissée 0.923 → 0.85 pour des cases mieux définies. Les états aria-invalid
        // (rouge) et data-active (ring) restent prioritaires par-dessus.
        "relative flex size-9 items-center justify-center border-y border-r border-[oklch(0.85_0.003_48.717)] text-sm shadow-xs transition-all outline-none first:rounded-l-md first:border-l last:rounded-r-md aria-invalid:border-destructive data-[active=true]:z-10 data-[active=true]:border-ring data-[active=true]:ring-3 data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:border-destructive data-[active=true]:aria-invalid:ring-destructive/20 dark:bg-input/30 dark:data-[active=true]:aria-invalid:ring-destructive/40",
        className
      )}
      {...props}
    >
